...
class ReleasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create release" do
    assert_difference('Release.count') do
      post releases_url, params: { release: { commit_hash: @release.commit_hash, name: @release.name } }
    end
  ...
  test "should update release" do
    patch release_url(@release), params: { release: { commit_hash: @release.commit_hash, name: @release.name } }
